...
class DashboardTimelineIntegrationTest {
    ...
    @Test
    void monthlyHistoryEndpointStillUsesRequestedMonth() throws Exception {
        mockMvc.perform(get("/api/v1/history/monthly")
                        .param("year", "2026")
                        .param("month", "4"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.year").value(2026))
    ...
    void quadrimesterCalendarBoundReturnsFirstCalendarQuadrimester() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/dashboard/timeline")
                        .param("view", "QUADRIMESTER")
                        .param("calendarYearBound", "true"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.view").value("QUADRIMESTER"))
                .andExpect(jsonPath("$.year").value(2026))
                .andExpect(jsonPath("$.month").value(1))
                .andExpect(jsonPath("$.startDate").value("2026-01-01"))
                .andExpect(jsonPath("$.endDate").value("2026-04-30"))
                .andExpect(jsonPath("$.label").value("Quadrimester 1 2026"))
                .andExpect(jsonPath("$.settings.calendarYearBound").value(true));
    }

    @Test
    void quadrimesterCalendarBoundReturnsSecondCalendarQuadrimester() throws Exception {
        mockMvc.perform(get("/api/v1/dashboard/timeline")
                        .param("view", "QUADRIMESTER")
                        .param("calendarYearBound", "true"))
                .andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.label").value("Quadrimester 2 2026"))
                .andExpect(jsonPath("$.settings.calendarYearBound").value(true));
    }

    @Test
    void quadrimesterCalendarBoundReturnsThirdCalendarQuadrimester() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/dashboard/timeline")
                ...
                .andExpect(jsonPath("$.label").value("Quadrimester 3 2026"))
                .andExpect(jsonPath("$.settings.calendarYearBound").value(true));
    }

    @Test
    void quadrimesterWithoutCalendarYearBoundReturnsRollingFourMonthRange() throws Exception {
        mockMvc.perform(get("/api/v1/dashboard/timeline")
                        .param("view", "QUADRIMESTER")
                ...
                .andExpect(jsonPath("$.startDate").value("2026-05-01"))
                .andExpect(jsonPath("$.endDate").value("2026-08-31"))
                .andExpect(jsonPath("$.label").value("May-Aug 2026"))
                .andExpect(jsonPath("$.settings.calendarYearBound").value(false));
    }

    @Test
    void quadrimesterGeneratesWeekdayAndWeekendBucketsUsingSundayWeekStart() throws Exception {
        mockMvc.perform(get("/api/v1/dashboard/timeline")
                        .param("view", "QUADRIMESTER")
                        .param("calendarYearBound", "false")
                        .param("startOfWeek", "SUNDAY"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.cells", hasSize(38)))
                .andExpect(jsonPath("$.cells[0].key").value("2026-04-26-WEEKDAY_BUCKET"))
                ...
                .andExpect(jsonPath("$.cells[1].key").value("2026-04-26-WEEKEND_BUCKET"))
                .andExpect(jsonPath("$.cells[1].cellType").value("WEEKEND_BUCKET"));
    }

    @Test
    void quadrimesterHonoursMondayWeekStartWhenGeneratingBuckets() throws Exception {
        mockMvc.perform(get("/api/v1/dashboard/timeline")
                        .param("view", "QUADRIMESTER")
                        .param("calendarYearBound", "false")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.cells", hasSize(38)))
                .andExpect(jsonPath("$.cells[0].key").value("2026-04-27-WEEKDAY_BUCKET"))
                .andExpect(jsonPath("$.cells[0].startDate").value("2026-05-01"))
                .andExpect(jsonPath("$.cells[0].endDate").value("2026-05-03"))
                .andExpect(jsonPath("$.cells[0].cellType").value("WEEKDAY_BUCKET"))
                .andExpect(jsonPath("$.cells[1].key").value("2026-04-27-WEEKEND_BUCKET"))
                .andExpect(jsonPath("$.cells[1].cellType").value("WEEKEND_BUCKET"));
    }

    @Test
    void quadrimesterMapsOccurrencesIntoWeekdayAndWeekendBuckets() throws Exception {
        mockMvc.perform(get("/api/v1/dashboard/timeline")
                        .param("view", "QUADRIMESTER")
                        .param("calendarYearBound", "false")
                        .param("startOfWeek", "SUNDAY"))
